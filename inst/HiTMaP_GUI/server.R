...
library(shiny)
if (!requireNamespace("promises", quietly = TRUE)) stop("Missing GUI dependency: promises")
library(promises)
library(stringr)
...
library(shiny)
library(shinyFiles)
if (!requireNamespace("dplyr", quietly = TRUE)) stop("Missing GUI dependency: dplyr")
library(dplyr)
