...
```{r warning=FALSE}
Peptide_modification(retrive_ID=NULL,update_unimod=F)
modification_list<-unimod.df[["modifications"]]
head(modification_list[,c("code_name","record_id","full_name","composition","mono_mass")])
```

You will also need to specify the position of a modifications
...
## Example data
The HitMaP comes with a series of Maildi imaging data set acquired from FT-ICR or TOF. By the following codes, you can download these raw data set from the recent release of HiTMaP.  
