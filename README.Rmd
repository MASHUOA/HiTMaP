...
library(HiTMaP)
wd=paste0(file.path(path.package(package="HiTMaP")),"/data/Bovinlens_Trypsin_FT/")
#set a series of imzML files to be processed
datafile=c("Bovin_lens")
wd
...
```{r echo=TRUE, message=TRUE, warning=FALSE, paged.print=F}
